...
class Adsform(models.Model):
    ...
    whatsapp_country_code = models.CharField(max_length=5, choices=COUNTRY_CODE_CHOICES, default='+91')
    ...
    ad_manager = models.CharField(max_length=15, choices=[('Self','Self'),('Staff','Staff'),('Third Party','Third Party')])
